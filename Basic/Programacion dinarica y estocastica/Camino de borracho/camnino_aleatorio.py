...
def simular_caminata(pasos, numero_de_intentos, tipo_borracho):
    ...
    borracho = tipo_borracho(name = 'Duvan')
...
def main(distancias_de_caminata, numero_de_intentos, tipo_borracho):
    ...
    for pasos in distancias_de_caminata: 
        ...
        distancia_manima = min(distancias)
        distancias_media_por_caminata.append(distancia_media)
        print(f'{tipo_borracho.__name__} camina aleatoria {pasos} pasos')
        print(f'Media: {distancia_media}')
        print(f'Max: {distancia_maxima}')
        print(f'Max: {distancia_manima}')
